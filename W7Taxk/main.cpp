...
void StartingText()
{
    ...
    for(int i = 0; text[i] != '\0'; i++)
    {
        ...
        sprintf(text,"  MD:Milon Hossain\n",5.00,8.00);
       // sprintf(text,"  Id: 182-15-11603",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -100 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
       ...
       //     sprintf(text,"  MD:Milon Hossain",5.00,8.00);
       sprintf(text,"  Id: 182-15-11603",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -100 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
          if(text[i]==' '  && text[i+1]==' ')
        {
            ...
            glRasterPos2f( 18 , -23 );
               ...
               sprintf(text,"  Section : E",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -100 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
          if(text[i]==' '  && text[i+1]==' ')
        {
           ...
           sprintf(text,"  Daffodil International University",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -100 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
